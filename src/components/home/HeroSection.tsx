  ...
  return (
    ...
    >
      <HeroZoom className="pointer-events-none absolute inset-0">
        ...
        <div
          className="absolute -left-[93px] -top-[181px] size-[752px] rounded-full opacity-[0.22]"
          style={{
            background:
        ...
        />
        <div
          className="absolute left-[403px] top-[385px] size-[769px] rounded-full opacity-[0.21]"
          style={{
            background:
      ...
      <Container className="relative z-10 pb-12 text-center md:pb-16">
        <FadeIn delay={0.1} y={20} className="mb-8 flex justify-center">
          <Badge
            variant="hero-dark"
        ...
        <FadeIn delay={0.9} y={20} className="mt-8 flex justify-center md:mt-10">
          <a
            href="/contact"
        ...
        <FadeIn delay={1.1} y={20} className="mt-12 border-t border-white/[0.07] pt-8 md:mt-16 md:pt-10">
          <HeroStats stats={hero.stats} />
        </FadeIn>
      </Container>

      <FadeIn delay={1.2} y={20} className="relative z-10 hidden justify-center pb-8 md:flex">
