      ...
      <section aria-label="Our Process" className="bg-peach py-16 md:py-20">
        <Container>
          ...
          <div className="relative isolate pt-8 md:pt-10">
            ...
            <StaggerContainer className="relative z-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-5 lg:gap-[3px]">
              {processSteps.map((step) => (
                <StaggerItem key={step.step}>
                  <article className="relative rounded-2xl border border-orange/[0.08] bg-white px-[25px] py-[33px] transition-[transform,box-shadow] duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_8px_28px_rgba(232,69,26,0.08)]">
