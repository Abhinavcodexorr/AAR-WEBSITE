          ...
          <StaggerContainer className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {insights.map((article) => (
              <StaggerItem key={article.title}>
                <article className="group flex flex-col overflow-hidden rounded-2xl border border-orange/[0.08] bg-white p-px transition-all duration-200 hover:border-orange/20 hover:shadow-[0_12px_40px_rgba(232,69,26,0.08)]">
